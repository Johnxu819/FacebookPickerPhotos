...
class PhotoAlbumsTableView: UIView,UITableViewDelegate, UITableViewDataSource ,PHPhotoLibraryChangeObserver{
...
//        let cancelButton = UIBarButtonItem(barButtonSystemItem: .Done, target: self, action: #selector(PhotoAlbumsTableViewController.eventViewControllerDismiss))
//        self.navigationItem.rightBarButtonItem = cancelButton
//        
//        
//        
//        let donelButton = UIBarButtonItem(barButtonSystemItem: .Cancel, target: self, action: #selector(PhotoAlbumsTableViewController.eventViewControllerDismiss))
//        self.navigationItem.leftBarButtonItem = donelButton
    ...
    // MARK: - Table view data source
     ...
     func showDetailPageModel(model: ImageModel)
     {
        photoCollectionViewController?.fetchResult=model.fetchResult
        photoCollectionViewController?.switchAlbums()
